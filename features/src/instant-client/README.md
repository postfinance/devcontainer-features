...
```json
"features": {
    "ghcr.io/postfinance/devcontainer-features/instant-client:1.1.0": {
        "version": "latest",
        "downloadUrl": "",
        "versionsUrl": ""
    }
...
|-----|-----|-----|-----|-----|
| version | The version of Instant Client to install. | string | latest | latest, 23, 21.23.0.0.0, 19.32.0.0.0 |
